...
class NCustomer(models.Model):
    ...
    customer_region_id = models.IntegerField()
    phone1 = models.CharField(max_length=30)
    phone2 = models.CharField(max_length=30)
    birthdate = models.DateField()
    marital_status = models.CharField(max_length=30)
    yearly_income = models.CharField(max_length=30)
    gender = models.CharField(max_length=30)
    total_children = models.SmallIntegerField()
    num_children_at_home = models.SmallIntegerField()
    education = models.CharField(max_length=30)
    date_accnt_opened = models.DateField()
